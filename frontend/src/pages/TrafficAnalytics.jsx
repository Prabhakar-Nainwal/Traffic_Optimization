    ...
    <div className="min-h-screen bg-white">
      <div className="border-b border-slate-200 bg-white">
        <div className="max-w-7xl mx-auto px-6 py-4">
          ...
          <p className="text-slate-500 text-xs mt-0.5">Monitor vehicle traffic patterns and trends</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-6">
        <div className="bg-white border border-slate-200 rounded-lg p-4 mb-4">
          <div className="mb-4">
            <p className="text-slate-700 text-xs font-semibold mb-2 uppercase tracking-wide">View By</p>
            ...
            {loading ? (
              ...
              <ResponsiveContainer width="100%" height={300}>
                ...
                >
                  ...
                  />
                  <Legend wrapperStyle={{ paddingTop: "12px", fontSize: "12px" }} iconType="square" />
                  <Bar dataKey="allowed" fill="#10b981" name="Allowed (Green)" radius={[4, 4, 0, 0]} />
                  <Bar dataKey="warned" fill="#f59e0b" name="Warned (Yellow)" radius={[4, 4, 0, 0]} />
                  <Bar dataKey="ignored" fill="#a78bfa" name="Ignored (Purple)" radius={[4, 4, 0, 0]} />
                </BarChart>
              </ResponsiveContainer>
            )}
          </div>
