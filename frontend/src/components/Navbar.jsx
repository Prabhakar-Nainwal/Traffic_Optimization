"use client"
import { Home, Car, MapPin, FileText, BarChart3 } from "lucide-react"
...
const Navbar = ({ activeScreen, setActiveScreen }) => {
  ...
  return (
    <div className="w-72 bg-gradient-to-b from-slate-50 via-white to-slate-50 border-r border-slate-200/60 text-foreground flex flex-col shadow-xl">
          ...
          return (
            ...
            >
              ...
              <div className="relative z-10 flex items-center gap-3">
                <div
                  className={`p-2 rounded-lg transition-all duration-300 ${isActive ? "bg-white/20 shadow-lg" : "bg-slate-100 group-hover:bg-slate-200 group-hover:shadow-md"
                    }`}
                >
                  <Icon
                    size={20}
